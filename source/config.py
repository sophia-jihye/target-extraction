...
output_dir = os.path.join(base_dir, 'output', '20200714-11-39-35')
...
class Parameters:
    def __init__(self):
        ...
        self.output_training_test_dfs_pkl_filepath = os.path.join(output_save_dir, 'training_test_dfs.pkl')
